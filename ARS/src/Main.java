...
public class Main {
   ...
   /* public static void loadSchedule() {
    ...
    public static void main(String[] args) {
        airportFile = new File("C:\\Users\\vader\\IdeaProjects\\CompSci240-FinalGroupProject1\\ARS\\src\\airports.csv");
        scheduleFile = new File("C:\\Users\\vader\\IdeaProjects\\CompSci240-FinalGroupProject1\\ARS\\src\\schedule.txt");
